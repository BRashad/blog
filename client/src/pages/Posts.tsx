...
import nilablog from "../assets/nilamaritablog.jpeg";
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <img className="rounded-t-lg" src={nilablog} alt="Nila Marita" />
              <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="https://www.youtube.com/watch?v=dwzPxlmMA7s">
                  Indonesian Startups in the Midst of a Pandemic
                </a>
              </h2>
              <p className="mb-5 font-light text-gray-500 dark:text-gray-400">
            ...
            <article className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              ...
              <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="src/pages/Post.tsx">This is a test blog article</a>
              </h2>
              <p className="mb-5 font-light text-gray-500 dark:text-gray-400">
                During the pandemic, many startups and even large companies were
                forced to rationalize and restructure in order to survive. In
